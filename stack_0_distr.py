...
data = all_data[37] #change for every data set , starts with 0 finish at 63
mean_lu1=data[0][1]
...
initial_landuse_types = np.random.choice(landuse_types, size=num_parcels, replace=True)
initial_landuse_types= np.floor(initial_landuse_types).astype(int)
